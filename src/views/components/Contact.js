...
const ContactComponent = (props) => {
  return (
    ...
    >
      ...
      <form className="flex md:w-6/12 w-11/12 md:mx-auto flex-col mx-auto" onSubmit={props.onSubmit}>
        <div className="flex justify-between w-11/12 m-3">
          ...
          <span className="flex flex-col w-11/12 m-3 mr-0">
            ...
            <input
              ...
              onChange={props.onChange}
              className= {` ${props.validEmail ? "border border-black" : "border-2 border-red-500" } p-1 w-full h-8 outline-none text-black`}
            />
          </span>
        </div>
